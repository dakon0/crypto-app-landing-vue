...
<style>
    ...
    .favorites-head .favorites-dots-btn {
        width: 24px;
        height: 24px;
    }
    .sidebar-content {
    ...
    .user-profile-tab .profile-photo img{
        margin-top: 5px;
    }
    .user-profile-tab .name-email {
        text-align: left;
        width: 89px;
        height: 34px;
        margin-right: 51px;
    }
    .user-profile-tab .name-email .name{
        font-weight: 600;
        font-size: 14px;
        line-height: 14px;
        color: #0A041C;
    ...
    .user-profile-tab .name-email .email{
        font-weight: 400;
        font-size: 14px;
        line-height: 14px;
        color: #9896A1;
